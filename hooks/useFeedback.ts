...
export const useFeedback = () => {
  ...
  const successFeedback = (message: string) => {
    toast({
      title: "Success",
      description: message,
      className: "bg-green-600 text-white p-4 rounded-lg shadow-lg flex space-x-4 !z-50",
  ...
  const errorFeedback = (message: string) => {
    toast({
      title: "Error",
      description: message,
      className: "bg-red-600 text-white p-4 rounded-lg shadow-lg flex space-x-4 !z-50",
