import { getFilms, deleteAllFilms } from '@/actions/javiTODO'; // Ensure `deleteAllFilms` is correctly imported
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({ message: 'All films deleted successfully' }, { status: 200 });
  } catch (error) {
